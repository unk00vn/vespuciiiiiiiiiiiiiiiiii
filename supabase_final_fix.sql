-- 1. Tworzenie tabeli udostępniania notatek
...
-- 2. Włączenie RLS (Security)
ALTER TABLE public.note_shares ENABLE ROW LEVEL SECURITY;

-- 3. Prosta polityka dostępu dla zalogowanych
CREATE POLICY "authenticated_access" ON public.note_shares FOR ALL TO authenticated USING (true);

-- 4. Dodanie kolumny chat_id do załączników (dla czatu)
DO $$ 
BEGIN 
