...
export const QuickActions = () => {
  const actions = [
    ...
    { name: "Baza Danych", icon: <Database className="h-5 w-5" />, path: "/database" },
    { name: "Ogłoszenia", icon: <Bell className="h-5 w-5" />, path: "/announcements" },
    { name: "Notatki", icon: <ClipboardList className="h-5 w-5" />, path: "/notes" },
    { name: "Czat", icon: <MessageSquare className="h-5 w-5" />, path: "/chat" },
    { name: "Zarządzanie", icon: <ShieldCheck className="h-5 w-5" />, path: "/account-management" },
    { name: "Mapa", icon: <MapPin className="h-5 w-5" />, path: "/" },
  ];
